...
CARPETA_ARCHIVOS = "bolsaDvalores/archivos" 
...
ACTIVOS_A_DESCARGAR = {
   ...
   "VES=X": "bolivar.csv",      # USD/VES (Tasa oficial)
    "BVCC.CR": "bolsa.csv",      # Bolsa de Caracas (BVCC.CR)
    "CCR.CR": "ceramica.csv",    # Ceramica
    "BPV.CR": "provincial.csv",  # Banco Provincial
    "PGR.CR": "proagro.csv",     # Proagro
